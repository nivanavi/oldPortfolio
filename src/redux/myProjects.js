const initionState = {
    projects: [
        {name: 'task-manager',
            description: 'SPA для планирования рабочего дня основная задача заключалась в написании полноценного приложения с front-end и back-end, а так же в закреплении знаний о javaScript библиотеке react.js и первом внедрении серверной части в прект.',
            color: '#2B2B2B',
        ...
        {name: 'rustrush',
            description: 'Заказ на верстку сайта по PSD макету, основной задачей было осуществить верстку с использованием генератора статичных сайтов jekyll и css фреймворка bootstrap, основные сложности были в изучении принципов работы jekyll и в первом использовании js.',
            color: '#2B2B2B',
            ...
            id: '2'},
        {name: 'g.l.a.z.',
            description: 'Этот проект задумывался как приложение для упрощения коммуниации менеджера с подчиненными, а так же для закрепления знаний о фреймворке vue.js, пока приложение не доделано, но будет дорабатываться в будущем.',
            color: '#2B2B2B',
            ...
            id: '3'},
        {name: 'noqus',
            description: 'Моим первым проектом стал лендинг для бота, по ходу его выполнения столкнулся с трудностями позицианирования элементов и осуществления адаптивности верстки, но от этого становилось только интереснее, по итогу работой остался доволен и был рад что удалось сдать первый заказ.',
            color: '#2B2B2B',
